...
public class Assembler {
    ...
    static {
        ...
        compAMap.put("A-1","110010");compAMap.put("D+A","000010");compAMap.put("D-A","010011");compAMap.put("A+D","000010") ;//added
        compAMap.put("A-D","000111");compAMap.put("D&A","000000");compAMap.put("D|A","010101");compAMap.put("A&D","000000");compAMap.put("A|D","010101");//added

        //put all comp posibilities with M into a HashMap,a=1
        compMMap.put("M","110000");compMMap.put("!M","110001");compMMap.put("-M","110011");
        compMMap.put("M+1","110111");compMMap.put("M-1","110010");compMMap.put("D+M","000010");compMMap.put("M+D","000010");
        compMMap.put("D-M","010011");compMMap.put("M-D","000111");compMMap.put("D&M","000000");compMMap.put("M&D","000000"); compMMap.put("M|D","010101");
	...
	public Assembler(String dir)
	{
		...
		try
		{
			...
			PrintWriter p = new PrintWriter(
					new File(fIn.getParentFile().getAbsolutePath() + "/" + fileName + ".hack")) ;
