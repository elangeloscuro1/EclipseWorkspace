...
package com.example.apk_camara.Capture;
  ...
  private class CustomSearchURLValidator implements Preference.OnPreferenceChangeListener {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
      if (!isValid(newValue)) {
        ...
        builder.setTitle("PreferencesFragment.java: R.string.msg_error");
        builder.setMessage("PreferencesFragment: R.string.msg_invalid_value");
