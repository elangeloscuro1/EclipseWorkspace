/**
 * Code:	Translate each field into its corresponding
 * 			binary value, and assembles the resulting
 * 			value in the form of 111accccccdddjjj
 * 			Literal value must be between 0 to 32767 (inclusive)
 * 
 * @author Angel Tapia
 * @version 1.0
 */
...
public class Code
{
	...
	/**
	 * DESCRIPTION:		Initializes hashmaps with code for easy lookup
	 * PRECONDITION:	comp = 7 bit (include a), dest/jump = 3 bits
	 ...
	 * 
	 * @param mnemonic: a valid comp mnemonic
	 ...
	 * 
	 * @param mnemonic: a valid dest mnemonic
	 ...
	 * 
	 * @param mnemonic: a valid jump mnemonic
	 ...
	 * 
	 * @param decimal: a number between 0-32767 (inclusive)
