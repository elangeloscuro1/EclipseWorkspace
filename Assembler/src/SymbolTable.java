 ...
 * 				-Symbols naming can start with
 * 				 abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_.$:
 * 				-Symbol can also contains numbers after the first letter.
 * 
 * @author Angel Tapia
 * @version 1.0
 */
...
{
	// Initial valid chars 
	private static final String INITIAL_VALID_CHARS = "abcdefghijklmnopqrstuvwxyz"
	 ...
	 * PRECONDITION:	All Assembler must include the same predefined symbols
	 ...
	 * @return true if symbol/address pair is successfully added;
	 * 			false if symbol exist in hashmap or symbol is invalid.  
	 */
	 ...
	 * 
	 * @param symbol for the wanted address
	 * @return if the specified symbol exists:
